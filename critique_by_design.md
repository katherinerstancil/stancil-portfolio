...
### Final Redesign
After receiving the feedback from my second sketch, I immediately looked at my visual and hated the different color shades for each food category. So, I quickly made a change to see how I liked each category corresponding to one shade. I thought this was beneficial change because it helps focus the audience a bit more. Then, I sent sketch 2 and my new design to my roommate, the graphic designer, and a few other individuals to see which design they liked better, and the new design got the majority. Following that change, I incorporated the feedback from my roommate and friend that is a graphic designer by adding a caption that clarifies what the farm share percentage is and removed the legend since the x-axis clarifies what each bar is. Below is the final design!
