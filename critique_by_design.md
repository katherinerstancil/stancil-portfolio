...
#### *Perceptibility: 1*
I rated this visualization a 1 for perceptiblity because it takes a lot of effort for the user to digest the information. The use of circles makes it really hard for the viewer to distinguish the sizes to make reasonable comparisons. For example, cheddar cheese, iceberg lettuce, peaches, and apples all look like the same value, but they are actually 4 distinct percentages. The viewer can see that they are similar, but it really does not allow to do much further than that.

#### *Truthfulness: 8*
I gave this visualization an 8 for truthfulness because it displays the data in a way that would not deceive the audience. I also like how the visual gave a disclaimer that the dates may vary because of the availability of data, and it was because that was the most recent data. However, I deducted the visual a few points because there was definitely more recent data available for several years, and the interactive data could be easily updated.

#### *Intuitiveness: 5*
This visual seems to have a pretty neutral intuitiveness, so I gave it a 5. I would say that the visual itself is easy to use (although it may not be the most useful), but the placement of the textbox with a basic definition of what the farm share was made it a bit more difficult to understand at first (it required more effort to find).

#### *Aesthetics: 9*
For aethetics, I completely ignored the fact that the visual was hard to understand, and I gave a lot of credit that the visualization itself was pretty. The colors were comforting, and the circles made the design unique, so I rated it a 9.

#### *Engagement: 2*
I feel like the nature of the data is relatively surface level for someone who does not know what the topic is about. However, I gave the visual 2 points for making me wonder why the farm share for dairy products seemed to be on average higher than other products, and why bread was so incredibly low compared to all other products.
...
I would also change the color scheme for the products. The color groupings seem to not have much correlation. The data source has categories for the products, but they do not correspond to the color choices in the visual.

### Redesign Sketches
The first sketch was me just jotting down my initial ideas of what I wanted the overall visual to look like. I wanted to change the bubble chart to a bar chart so that I can categorize the food products and make the data understood easier than the initial design. In my first design, I created the categories by color coding the bars and labeling them. However, one thing I did not like was that this sketch eliminated the name of the food product. I felt as if I tried to cram it in, it would look overwhelming and too much. 

Therefore, I decided to make a second sketch on Tableau to see if there was a way to incorporate both. When I told Tableau that I wanted both the food category and product on the chart, it put the category on the top and separated it by a line. Then, the food product was on the x-axis. The only thing I had to change was the color palette for the category to correspond to different shades of a color. I also took out the year in the data points because I did not think it was completely necessary, but I did write a quick disclaimer that the data corresponded with the most recent year available per product.
...
### Final Redesign
After receiving the feedback from my second sketch, I immediately looked at my visual and hated the different color shades for each food category. So, I quickly made a change to see how I liked each category corresponding to one shade. I thought this was a beneficial change because it helps focus the audience a bit more. Then, I sent sketch 2 and my new design to my roommate, the graphic designer, and a few other individuals to see which design they liked best, and the new design got the majority. Following the color change, I incorporated the feedback I received by adding a caption that clarifies what the farm share percentage is (to avoid the confusion that my roommate had) and removed the legend since the x-axis clarifies what each bar is (to avoid redundancy). Below is the final design!
